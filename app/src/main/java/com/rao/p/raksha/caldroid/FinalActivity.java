...
public class FinalActivity extends AppCompatActivity {
    ...
    private com.rao.p.raksha.caldroid.InfixToPostfix useritp;
    private com.rao.p.raksha.caldroid.Tree modeltree;
    private com.rao.p.raksha.caldroid.Tree usertree;
